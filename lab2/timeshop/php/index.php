...
if (isset($_GET['button'])){
    ...
    $search = $_GET['search'];
        ...
        if ($option == "id") {
           $sqlquery = "SELECT * FROM tbl_watchts WHERE watch_id LIKE '%$search%'";
        }
        if ($option == "country") {
            $sqlquery = "SELECT * FROM tbl_watchs WHERE watch_country LIKE '%$search%'";
        }
} else {
...
<div class="w3-card w3-container w3-padding w3-margin w3-round w3-pale-blue">
        <h4>Watch Search</h4>
    ...
    <div class="w3-grid-template">
        <?php
            foreach ($rows as $watchs){
                ...
                <div class='w3-padding'><a href='watch_details.php?watch_id=$watch_id'><img class='w3-image' src=../images/watchs/$watch_id.jpg onerror=this.onerror=null;this.src='../images/watchs/default.png'></a></div>
                <hr>
                ...
                <p><div class='w3-container'><a href='#' class='w3-btn w3-blue w3-round'>Add to Cart</a></div></p>
                <br>
                </div></div>";
            }
        ?>
